(function(){
  ...
  function itemHtml(r,ma){var v=verdict(r,ma),e=v.score>=70?'🟢':v.score>=45?'🟡':'🔴';return '<div class="v17-item" style="display:block!important;width:100%;padding:14px 0;border-top:1px solid var(--line);clear:both;">'+'<div style="display:block!important;width:100%;font-weight:900;line-height:1.25;margin-bottom:8px;white-space:normal;overflow-wrap:anywhere;">'+e+' '+r.t+' '+pct(r.pl)+'</div>'+'<div style="display:block!important;width:fit-content;max-width:100%;position:static!important;clear:both;">'+'<span class="pill '+cl(v.score)+'" style="display:inline-block!important;position:static!important;white-space:normal;line-height:1.15;max-width:100%;text-align:center;">'+v.action+'</span>'+'</div>'+'</div>'}
  function html(rows,ma){var best=rows.slice().sort(function(a,b){return b.pl-a.pl})[0],worst=rows.slice().sort(function(a,b){return a.pl-b.pl})[0];var head=ma>=70?'Mercato costruttivo':ma>=45?'Mercato selettivo':'Mercato difensivo';var h='<section id="home-v17-stable" class="card hero" style="display:block!important;overflow:hidden;"><div style="display:block!important;width:100%;"><div class="section-title"><h2>Cosa fare oggi</h2><span class="rating">V17</span></div><p><b>'+head+'</b> · Macro '+ma+'/100. Prima gestione rischio, poi nuove opportunità.</p><div class="v17-list" style="display:block!important;width:100%;margin:14px 0;">';rows.forEach(function(r){h+=itemHtml(r,ma)});h+='</div>';if(best&&worst)h+='<p><b>Migliore:</b> '+best.t+' '+pct(best.pl)+' · <b>Più delicata:</b> '+worst.t+' '+pct(worst.pl)+'</p>';h+='<p><b>Regola V17:</b> niente mediazioni impulsive senza conferma macro, settore e catalyst.</p></div></section>';return h}
